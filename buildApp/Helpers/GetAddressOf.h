...
namespace Helpers
{
    ...
    struct GetAddressOfTraitsResetMethod
    {
        typedef Val Val;
    ...
    struct GetAddressOfTraits<std::unique_ptr<Val, Del>> : public GetAddressOfTraitsResetMethod<std::unique_ptr<Val, Del>, Val> {};

    template<class Val>
    struct GetAddressOfTraits<std::shared_ptr<Val>> : public GetAddressOfTraitsResetMethod<std::shared_ptr<Val>, Val> {};
